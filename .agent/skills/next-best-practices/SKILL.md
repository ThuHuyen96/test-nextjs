...
description: Use when building Next.js apps to enforce best practices for file conventions, RSC boundaries, data patterns, async APIs, metadata, error handling, route handlers, image/font optimization, and bundling.
category: Framework
...
- `'use cache'` (Next.js 16+) - See [next-cache-components](../next-cache-components/SKILL.md) for detailed patterns.
...
See [next-upgrade](../next-upgrade/SKILL.md) for upgrading to the latest Next.js version.
