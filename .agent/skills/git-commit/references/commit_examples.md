...
> **Use this format unless the user explicitly asks for a detailed commit.**
> Single line, max 100 chars (ideally under 80), no body.

```
feat(auth): add OAuth2 login flow
fix(api): handle null response from upstream
refactor(utils): extract date formatter helper
...
security(cookie): sanitize session token input
```

---

## 📝 Detailed Commits (ONLY when explicitly requested)
